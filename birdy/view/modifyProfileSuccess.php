		...
		<div id="user-info-block">
			...
			<div class="info-element">
				...
				<div id="user-statut">
					...
					<div id="error-statut" class="error-message"><?php echo $context->error_msg['statut']; ?></div>
				</div>
			<div class="info-element">
				...
				<div id="user-login">
					...
					<div id="error-password" class="error-message"><?php echo $context->error_msg['old-password']; ?></div>
					<input id="password" name="new-password" type="password" placeholder="Nouveau mot de passe" onblur="checkPassword()">
					<div id="error-password" class="error-message"><?php echo $context->error_msg['new-password']; ?></div>
				</div>
			</div>
			<div class="info-element">
				...
				<div id="user-firstname">
					...
					<div id="error-firstname" class="error-message"><?php echo $context->error_msg['firstname']; ?></div>
				</div>
			</div>
			<div class="info-element">
				...
				<div id="user-name">
					...
					<div id="error-name" class="error-message"><?php echo $context->error_msg['name']; ?></div>
				</div>
			</div>
			<div class="info-element" style="overflow:auto;">
				...
				<div id="error-avatar" class="error-message"><?php echo $context->error_msg['avatar']; ?></div>
			</div>
